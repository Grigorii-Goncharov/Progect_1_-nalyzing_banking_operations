...
@pytest.mark.parametrize("input_date, expected_output", [
    (
        "2021-05-20 15:30:00",
        ["01.05.2021 15:30:00", "20.05.2021 15:30:00"]
    ),
    (
        "2022-01-01 00:00:00",
        ["01.01.2022 00:00:00", "01.01.2022 00:00:00"]
    ),
    (
        "2023-12-31 23:59:59",
...
def test_get_data_period_invalid_format():
    ...
    #  Тест обработки на возврат тестового фрейма данных
...
# def test_get_top_transactions_negative_top(test_df):
#     """Тест с отрицательным значением top"""
#     with pytest.raises(ValueError):
#         get_top_transactions(test_df, -1)

    # Тест для получения курсов валют
@patch("requests.get")
...
def test_get_currency_non_200_status(mock_get, tmp_path):
    ...
    # Тест для получения стоимости акций
@patch("requests.get")
